...
public class FragSorGaussSeidel extends Fragment {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    sor_gauss_seidel(A, b, x0, tolerance, niter, n, relax, helpView);
                } catch (Exception e) {
    ...
    public void sor_gauss_seidel(double[][] A, double[] b, double[] x0, double tol, int niter, int n, double sorCte, View helpView) {
        double det = det(A);
        if(det == 0) {
            isError = true;
