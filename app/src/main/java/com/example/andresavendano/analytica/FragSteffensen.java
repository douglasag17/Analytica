...
public class FragSteffensen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.frag_steffensen, container, false);
        ...
        //Table
        table = v.findViewById(R.id.tableSteffensen);
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    steffensen(x, tolerance, niter, gx);
                } catch (Exception e) {
    ...
    public void steffensen(double x, double tolerance, int niter, String g) {
        Expression gx = new Expression(g).setPrecision(16);
        BigDecimal x1d = gx.with("x", Double.toString(x)).eval();
        double x1 = x1d.doubleValue();
        BigDecimal x2d = gx.with("x", Double.toString(x1)).eval();
        double x2 = x2d.doubleValue();
        int count = 0;
        ...
        table.addView(fila);
        while (x1 != 0 && x2 != 0 && error > tolerance && count < niter) {
            double xn = x2 - (Math.pow((x2 - x1), 2)) / (x2 - 2 * x1 + x);
            x1d = gx.with("x", Double.toString(x)).eval();
            x1 = x1d.doubleValue();
            x2d = gx.with("x", Double.toString(x1)).eval();
            x2 = x2d.doubleValue();
            ...
            tv_col44.setText(String.format("%.6f", x2)+"   ");
