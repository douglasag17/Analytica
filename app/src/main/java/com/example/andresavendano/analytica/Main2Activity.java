...
public class Main2Activity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    fragment=new FragIncremental();
                    break;
                case 1:
                    fragment=new FragBisection();
                    break;
                case 2:
                    fragment=new FragFalsePosition();
                    break;
                case 3:
                    fragment=new FragFixedPoint();
                    break;
                case 4:
                    fragment=new FragNewton();
                    break;
                case 5:
                    fragment=new FragSecant();
                    break;
                case 6:
